	...
	<div class="review-text">
		...
		<div class="review-autor">
			...
			<?foreach($arResult["DISPLAY_PROPERTIES"] as $pid=>$arProperty):?>
				<?if(is_array($arProperty["DISPLAY_VALUE"]) || $pid == 'DOCUMENTS') continue;?>
				<?$arrProps[] = $arProperty["DISPLAY_VALUE"];?>
			<?endforeach;?>
			<?=implode(", &nbsp;", $arrProps);?>
...
<?//echo '<pre>'; var_dump($arResult['DISPLAY_PROPERTIES']['DOCUMENTS']['FILE_VALUE']); echo '</pre>';?>
...
<div class="exam-review-doc">
	...
	<?if(!isset($arResult['DISPLAY_PROPERTIES']['DOCUMENTS']['FILE_VALUE']['ID'])):?>
		<?foreach($arResult['DISPLAY_PROPERTIES']['DOCUMENTS']['FILE_VALUE'] as $value):?>	
